...
## **3. Dashboard for DataScience job trends across the world**
...
I have used this case to create a prediction model which predicts popular books wiht 85% accuracy.
